...
//	BitmapDescriptor mCurrentMarker;
	...
	private void initBaiduMap() {
		...
		if("select".equals(type)) {
			initTopBarForBoth("位置", R.drawable.btn_login_selector, new onRightImageButtonClickListener() {
				@Override
				public void onClick() {
					gotoChatPage();
				}
	...
	private void initLocClient() {
		...
		option.setProdName("bmobchat");// 设置产品线
	...
	public class BaiduReceiver extends BroadcastReceiver {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (str.equals(SDKInitializer.SDK_BROADTCAST_ACTION_STRING_PERMISSION_CHECK_ERROR)) {
				showToast("key验证出错,请在 AndroidManifest.xml 文件中检查 key设置");
